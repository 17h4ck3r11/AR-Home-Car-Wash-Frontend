      ...
      <Modal.Body className="grid-example">
        <Container>
          <Row>
            ...
            <Col xs={12} md={12}>
              <h2 style={{textAlign:"center"}}>Employee has been Deleted!</h2>
            </Col>
          </Row>
        </Container>
      </Modal.Body>
...
function ListEmployees() {
  ...
  const deleteCustomer = async (id) => {
    let result = await fetch(`${process.env.REACT_APP_BACKEND_URL}/employee/${id}`, {
      method: 'delete'
    })
    ...
    <div className='details' style={{gridTemplateColumns: "none"}}>
      <div className="recentOrders">
        <div className="cardHeader">
          <h2>Employees</h2>
          <input type="text" placeholder='Search Employee' className='searchField' onChange={handleSearch}/>
        </div>
        <table>
          <thead>
            <tr>
